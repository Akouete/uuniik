...
@section('content')
  ...
  ?>
  <title>Uuniik | personnes</title>
  <link rel="stylesheet" href="{{ asset('css/personnes.css') }}">
  ...
  <div class="row cont margin_bottom50" style="margin-top: 110px">
    ...
    <div class="contbtnques bg_white">
      ...
      <?php
        $users = DB::select('select * from uuniik_user');
        ...
        <div class="col-6 col-sm-6 col-md-4 col-lg-2 contqcard">
          <div class="qcard">
            ...
            <div class="qcardcenter">
              <p><i class="material-icons icon_list">public</i> {{ $users[$i]->user_description }} </p>
              <p>{{ $users[$i]->user_subscribes }} Abonnées</p>
            </div>
            <div class="height50 bg-white center qcardbottom">
              <a class="red1 radius20 mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" style="color: #D50000;">
                <i class="material-icons red1">favorite</i>&nbsp; Suivre
              </a>&nbsp;&nbsp;
              <button class="mdl-button mdl-js-button mdl-button--icon" id="btnm<?=$j?>">
                <i class="material-icons icondark">more_vert</i>
              </button>
              <ul class="mdl-menu mdl-menu--top-right mdl-js-menu mdl-js-ripple-effect" data-mdl-for="btnm<?=$j?>">
                <li class="mdl-menu__item"><i class="material-icons gray icon_list">view_module</i>&nbsp; Publications</li>
  ...
  <script type="text/javascript" async src="{{ asset('js/AjaxFileScript/personnes.js') }}" ></script>
